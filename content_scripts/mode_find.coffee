...
class PostFindMode extends SuppressPrintable
  ...
  constructor: ->
    ...
    unless document.activeElement and DomUtils.isEditable document.activeElement
      return
...
class FindMode extends Mode
  ...
  @updateQuery: (query) ->
    ...
    if @query.isRegex
      @query.regexMatches = regexMatches
    if @query.isRegex
  ...
  @execute: (query, options) ->
    ...
    if document.activeElement and DomUtils.isEditable document.activeElement
      unless DomUtils.isSelected document.activeElement
