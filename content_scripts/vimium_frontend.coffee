...
#
# Show the disabled message when the focus is lost since vimium won't be able to detect any command at this stage.
#
...
#
window.enterInsertMode = enterInsertMode = (target) ->
