var domUtils = {
  ...
  flashElement: function(element) {
    var oldShadowValue = element.style.boxShadow;
    element.style.boxShadow = '0px 0px 4px 2px #4183C4';
    setTimeout(function(){element.style.boxShadow = oldShadowValue;}, 400);
  },
