...
if window? and chrome?.extension?.getBackgroundPage?() == window
  ...
  # For building ../pages/vimium_resources.html via "cake build".
  for own key, value of getVimiumResources()
    exports[key] = value
