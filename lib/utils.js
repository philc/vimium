...
var Utils = {
    ...
    haveChromeVersion(required) {
        var _a;
        const match = (_a = navigator.appVersion) === null || _a === void 0 ? void 0 : _a.match(/Chrom(e|ium)\/(.*?) /);
...
class SimpleCache {
    ...
    rotate(force) {
        ...
        Utils.nextTick(() => {
            if (force || (this.entries < Object.keys(this.cache).length) || (this.expiry < (new Date().getTime() - this.lastRotation.getTime()))) {
                this.lastRotation = new Date();
