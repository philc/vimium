...
const Utils = {
  ...
  // initializeFrame message, which sets eacch of these values.
  ...
  // null. Firefox's implementation of this function has the correct behavior.
  // To work around this, we use an anonymous async function inside the handler that we pass to
  // addListener.
  // See here for the workarounds: https://stackoverflow.com/q/44056271
  // - listenerFn: this can be async, and can return a value to the message sender.
  addChromeRuntimeOnMessageListener(listenerFn) {
