...
const Utils = {
  ...
  debugLog() {
    if (this.debug) {
      console.log.apply(console, ["Vimium"].concat(Array.from(arguments)));
    }
  },

  // TODO(philc): Hard-coding this while we decouple it from Frames communication. Perhaps put it
...
Object.assign(globalThis, { Utils, SimpleCache, AsyncDataFetcher, JobRunner, EventDispatcher });
