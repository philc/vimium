...
context('extractQuery', () => {
  should('extract queries from search URLs', () => {
    assert.equal(
      'bbc sport 1',
      Utils.extractQuery('https://www.google.ie/search?q=%s', 'https://www.google.ie/search?q=bbc+sport+1'),
    );
    assert.equal(
      'bbc sport 2',
      Utils.extractQuery('http://www.google.ie/search?q=%s', 'https://www.google.ie/search?q=bbc+sport+2'),
    );
    assert.equal(
      'bbc sport 3',
      Utils.extractQuery('https://www.google.ie/search?q=%s', 'http://www.google.ie/search?q=bbc+sport+3'),
    );
    assert.equal(
      'bbc sport 4',
      Utils.extractQuery('https://www.google.ie/search?q=%s', 'http://www.google.ie/search?q=bbc+sport+4&blah'),
    );
  });
});
